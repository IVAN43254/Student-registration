...
class SMTP
{
    ...
    public function authenticate(
        ...
        switch ($authtype) {
            ...
            case 'LOGIN':
                ...
                if (!$this->sendCommand('name', base64_encode($name), 334)) {
                    return false;
                }
            ...
            case 'CRAM-MD5':
                ...
                //Build the response
                $response = $name . ' ' . $this->hmac($challenge, $password);

                //send encoded credentials
                return $this->sendCommand('name', base64_encode($response), 235);
            case 'XOAUTH2':
    ...
    public function client_send($data, $command = '')
    {
        ...
        if (
            ...
            in_array($command, ['User & Password', 'name', 'Password'], true)
        ) {
